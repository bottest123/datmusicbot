...
#- * -coding: utf - 8 - * -##Simple telegram bot to download music from datmusic(https: //github.com/alashow/music).
  #Currently just works with inline queries.#Beta!Code is litte bit too simple: )
...
from telegram
import InlineQueryResultAudio, ParseMode, InlineKeyboardMarkup, InlineKeyboardButton
from telegram.ext
import Updater, InlineQueryHandler, CommandHandler
import logging

import settings
import text
from constants
import DATMUSIC_API_ENDPOINT
from constants
import INLINE_QUERY_CACHE_TIME
